...
<body>
    <form class="conainer" action="/Eleicao/autorizar" id="autorizar" method="POST">
        <div class="aut">
          <label>Titulo do Eleitor</label>
            <input type="text" name="usuario" id="usuario" placeholder="titulo do eleitor" value="${requestScope.usuario}" required/>
        </div>            
        <div class="aut">
          <label>Nome</label>      
        ...
        <button class="other" onclick="voltar()">Voltar</button>
    </form>
</body>
</html>